...
const About = () => {
  ...
  const testimonials = [
    { imageSrc: 'https://cdn-hgnkf.nitrocdn.com/kXwIsxgQvTuqBCHJVxgGzMFyBupVegkm/assets/images/optimized/rev-ffda420/www.tech-prastish.com/wp-content/uploads/2023/01/45-mudbrick-cottage.png', content: 'Imagine a world without any herbs, spices or flowers... There would be no tasty food, no soothing teas, and no fragrance... Life would be a bland and dull existence... And our daily routines wouldn’t be the same. Now try to remember the taste of a hearty, wholesome meal or go back to the time you sniffed a bottle of heavenly perfume. Your senses were engulfed in a wave of delight, right?' },
